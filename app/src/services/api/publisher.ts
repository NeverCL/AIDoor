...
/** 此处后端没有提供注释 GET /api/Publisher/${param0}/my-rating */
...
/** 此处后端没有提供注释 GET /api/Publisher/${param0}/ratings */
export async function getPublisherIdRatings(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getPublisherIdRatingsParams,
  options?: { [key: string]: any },
) {
  const { id: param0, ...queryParams } = params;
  return request<any>(`/api/Publisher/${param0}/ratings`, {
    method: 'GET',
    params: {
