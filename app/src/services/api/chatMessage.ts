...
export async function getMessagesPublisherMessages(
  ...
  return request<API.PagedResultOfChatMessageDto>(
    '/api/messages/publisher-messages',
    {
      method: 'GET',
      params: {
        ...params,
...
export async function getMessagesPublisherUnreadCount(options?: {
  [key: string]: any;
}) {
...
export async function getMessagesPublisherUsers(options?: {
  [key: string]: any;
}) {
...
export async function getMessagesUserPublishers(options?: {
  [key: string]: any;
}) {
  return request<API.ConversationPublisherDto[]>(
    '/api/messages/user-publishers',
    {
      method: 'GET',
      ...(options || {}),
    },
...
export async function getMessagesUserUnreadCount(options?: {
  [key: string]: any;
}) {
