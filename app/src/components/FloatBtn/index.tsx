    ...
    return (
        <>
            <div className='left-10 right-10 bottom-10 fixed bg-[#151515] h-14 rounded-[1.72rem] flex justify-between items-center px-12 text-sm'>
                <NavLink to='/home' className={({ isActive }) => 'flex items-center ' + (isInHomeGroup ? 'text-primary' : 'text-secondary')}>
                ...
                <NavLink to='/my' className={({ isActive }) => 'flex items-center ' + (!isInHomeGroup ? 'text-primary' : 'text-secondary')}>
